...
from Biblioteca_BackEnd.api.viewsFolder.usuarioView import usuarioLCView, usuarioRUView, recoveryCView, customeLCView
...
urlpatterns = [
    ...
    url(r'^'+'custome/'+'$', customeLCView.as_view(), name="usuario-lc"),
