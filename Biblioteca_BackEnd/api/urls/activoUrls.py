...
urlpatterns = [
    ...
    url(r'^'+ACTIVO+ACTIVOBYSECCION+'(?P<fk>\d+)$', ActivoBySeccionLView.as_view(), name="activobyseccion-l"),
    url(r'^'+ACTIVO+ACTIVOBYUSUARIO+'(?P<fk>\d+)$', ActivoByUsuarioLView.as_view(), name="activobyusuario-l"),
    url(r'^'+ACTIVO+ACTIVOBYNUMEROACTIVO+'(?P<numeroactivo>[a-zA-Z0-9]+)$', ActivoByNumeroActivoLView.as_view(), name="activobynumeroactivo-l"),
]